...
PRODUCT_PACKAGES += \
	...
	android.hardware.memtrack-service.samsung.sm8250 \
    gralloc.kona \
...
# LiveDisplay
PRODUCT_PACKAGES += \
    vendor.lineage.livedisplay@2.0-service.sm8250
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/nfc/configs/libnfc-nci.conf:$(TARGET_COPY_OUT_PRODUCT)/etc/libnfc-nci.conf
